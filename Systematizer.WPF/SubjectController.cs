...
class SubjectController : ListBlockController
{
    ...
    { 
        ...
        var withChildren = UIService.BoxesWithChildren(rootIds, true);
    ...
    {
        var children = UIService.LoadBoxesByParent(parent.Persistent.RowId, true);
        ...
        var withChildren = UIService.BoxesWithChildren(ids, true);
