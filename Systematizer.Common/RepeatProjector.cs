...
public class RepeatProjector
{
    ...
    public static string AdvanceTime(string boxTime, ParsedRepeatInfo repeats)
    {
    ...
    public static IEnumerable<AgendaEntry> Project(CachedBox box, bool includeCurrent, bool allowAbortOnLowClutter)
    {
    ...
    static DateTime? NextTime(DateTime d, DateTime max, ParsedRepeatInfo.RepeatEntry r, int hour, int minute)
    {
    ...
    /// </summary>
    static (DateTime?, DateTime?) CalcPendingReminder(CachedBox box)
    {
